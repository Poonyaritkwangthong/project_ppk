            ...
            <div className="p-10">
                ...
                <div className="bg-[#20a68a] w-[110rem] h-full mx-auto mt-10 rounded-xl p-5">
                    <div className="flex gap-6">
                        <div className="">
                            <button className="bg-white p-2 rounded-xl text-[#20a68a]">
                                เพิ่มขนาดตัวหนังสือ +
                            </button>
                        </div>
                        <div className="">
                                ...
                                <div className="flex gap-[2rem] mt-2">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => changeFieldHandler(e)}
                                            value={addNews.start_announcing}
                                        />
                                    </div>
                                    <div>
                                        <label htmlFor="" className="text-[#20a68a]">
                                ...
                                <div className="flex gap-[2rem] items-center mt-2">
                                    ...
                                    <div>
                                        <input
                                            ...
                                            type="radio"
                                            name="news_status"
                                            checked={addNews.news_status === "start"}
                                            value="start"
                                            onChange={(e) => changeFieldHandler(e)}
                                        />
                                    ...
                                    <div>
                                        <input
                                            ...
                                            type="radio"
                                            name="news_status"
                                            checked={addNews.news_status === "stop"}
                                            value="stop"
                                            onChange={(e) => changeFieldHandler(e)}
                                        />
